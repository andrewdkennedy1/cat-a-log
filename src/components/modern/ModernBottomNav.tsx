import { MapIcon, List, Grid, PawPrint } from 'lucide-react';
...
export function ModernBottomNav({ viewMode, onViewModeChange, onAdd }: ModernBottomNavProps) {
  return (
      ...
      <div className="flex items-center justify-around h-full">
        ...
        <div className="w-16">
          <Button
            ...
            variant="secondary"
            onClick={onAdd}
            className="absolute left-1/2 -translate-x-1/2 -top-6 h-16 w-16 rounded-full shadow-lg"
          >
